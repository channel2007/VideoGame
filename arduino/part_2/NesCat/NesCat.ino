...
#define NES_FOLDER ("/FC/")

#define BLUETOOTH_ENABLED
//#define KEYBOARD_ENABLED
#define JOYSTICK_ENABLED_FC
...
#ifdef JOYSTICK_ENABLED_FC
  controllers.poll();
  if(controllers.down(0, GameControllers::A)){ value |= 1; }//A  
  if(controllers.down(0, GameControllers::B)){value |= 2; }//B 
  if(controllers.down(0, GameControllers::SELECT)){value |= 4;} //SELECT      
  if(controllers.down(0, GameControllers::START)){value |= 8;} //START
  if(controllers.down(0, GameControllers::UP)){value |= 16;} //UP
  if(controllers.down(0, GameControllers::DOWN)){value |= 32;} //DOWN
  if(controllers.down(0, GameControllers::LEFT)){value |= 64;} //LEFT
  if(controllers.down(0, GameControllers::RIGHT)){value |= 128;} //RIGHT
  if(controllers.down(0, GameControllers::SELECT) && controllers.down(0, GameControllers::START)){NES_POWER = 0;} //EXIT
...
//--------------------------------------------------------------------------------
#ifdef JOYSTICK_ENABLED_FC
  controllers.init(PIN_LATCH, PIN_CLOCK); 
  controllers.setController(0, GameControllers::NES, PIN_DATA);  
  //controllers.setController(0, GameControllers::SNES, PIN_DATA);  
#else
